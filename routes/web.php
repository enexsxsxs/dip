...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('reports.add')->group(function () {
        Route::get('/document-headers', [DocumentHeaderController::class, 'index'])->name('document-headers.index');
        Route::get('/document-headers/create', [DocumentHeaderController::class, 'create'])->name('document-headers.create');
        Route::post('/document-headers', [DocumentHeaderController::class, 'store'])->name('document-headers.store');
        Route::get('/document-headers/{document_header}/edit', [DocumentHeaderController::class, 'edit'])->name('document-headers.edit');
        Route::put('/document-headers/{document_header}', [DocumentHeaderController::class, 'update'])->name('document-headers.update');
        Route::delete('/document-headers/{document_header}', [DocumentHeaderController::class, 'destroy'])->name('document-headers.destroy');
